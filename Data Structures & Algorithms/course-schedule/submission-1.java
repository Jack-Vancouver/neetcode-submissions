class Solution {
    public boolean canFinish(int numCourses, int[][] prerequisites) {
        ...
        // 入度(indegree)：指一门课有几个前置条件。如果入度为 0，说明这是一门没有任何门槛的基础课。
        // 出度：指修完这门课，能解锁几门后续的高级课。
        ...
        // 3. 把所有没有任何门槛的课（入度为 0）加入队列（Queue先入先出），准备开学！
        // 找出所有入度为 0（没有前置条件）的课，把它们全部扔进一个队列（Queue）里。这些是你第一学期直接就能上的课。
